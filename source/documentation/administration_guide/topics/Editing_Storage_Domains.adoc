...
[NOTE]
====
iSCSI storage connections cannot be edited via the Administration Portal, but can be edited via the REST API. See link:http://ovirt.github.io/ovirt-engine-api-model/4.4/#services[Updating Storage Connections] in the _REST API Guide_.
====
