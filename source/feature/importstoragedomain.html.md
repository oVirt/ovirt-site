...
Shareable and direct lun disks are not supported in the OVF file today, hence if a VM includes a shareable or direct lun disksm, a warning will be prompted to the user, indicating the following:
