...
This quick start guide is adapted from the [RHEV 3.0 quick start guide](http://docs.redhat.com/docs/en-US/Red_Hat_Enterprise_Virtualization/3.0/html/Quick_Start_Guide/index.html). The fundamentals are the same between RHEV and oVirt, but this document could use more checking against oVirt 3.x
...
1. Download the latest version of ovirt Node from [oVirt Node release](http://resources.ovirt.org/releases/3.3/iso/) and burn the ISO image onto a disc.
