...
* Ensure that the host hardware meets the requirements for PCI device passthrough and assignment. See link:{URL_virt_product_docs}{URL_format}planning_and_prerequisites_guide/index#PCI_Device_Requirements_oVirt_planning[PCI Device Requirements] for more information.
