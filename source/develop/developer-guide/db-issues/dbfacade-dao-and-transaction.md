...
*Events: severity > normal sortby time* (Displays the list of all Events whose severity is higher than Normal sorted by time)
 ...
 The Administration Portal provides auto-completion to help you create valid and powerful search queries.
 ...
 You can either select from the list and then continue typing/selecting the next part of the search, or ignore the options and continue entering your query manually.
...
[step-by-step Guide](/develop/developer-guide/introducing-entity-search.html)
...
* Check JBOSS standalone.xml and verify that user/database  and all relevant settings are OK
