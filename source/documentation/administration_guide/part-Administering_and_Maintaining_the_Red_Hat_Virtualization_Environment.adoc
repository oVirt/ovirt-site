...
[id="part-Administering_and_Maintaining_the_Red_Hat_Virtualization_Environment_{context}"]
...
include::chap-Global_Configuration.adoc[]

include::chap-Dashboard.adoc[]

include::chap-Searches.adoc[]

include::chap-Bookmarks.adoc[]

include::chap-Tags.adoc[]
