...
The Dashboard requires that Data Warehouse is installed and configured. See link:{URL_virt_product_docs}data_warehouse_guide/[Installing and Configuring Data Warehouse] in the _Data Warehouse Guide_.
