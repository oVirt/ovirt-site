...
//, and link:{URL_virt_product_docs}virtual_machine_management_guide/#Adding_a_Network_Interface[Adding a New Network Interface] in the _Virtual Machine Management Guide_.
