...
***org.ovirt.engine.core.common.businessentities.QuotaStatic*** - A business entity that reflects quota static (see #REDIRECT [Target page#quota_static](Target%20page#quota_static))
