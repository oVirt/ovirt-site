...
| link:{URL_virt_product_docs}html/installing_red_hat_virtualization_as_a_self-hosted_engine_using_the_cockpit_web_interface/migrating_to_remote_servers_she_cockpit_deploy#Migrating_the_self-hosted_engine_database_SHE_cockpit_deploy[No, but can be enabled].
...
| Disabled by default. link:{URL_virt_product_docs}html/installing_red_hat_virtualization_as_a_self-hosted_engine_using_the_cockpit_web_interface/migrating_to_remote_servers_she_cockpit_deploy#Migrating_the_self-hosted_engine_database_SHE_cockpit_deploy[No, but can be enabled].
|====
