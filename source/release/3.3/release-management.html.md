...
| Storage         | Separating "Move" vm operation to "Copy" and "Delete" operations to improve VM availability    | Optional               | [Liron Aravot](User:laravot)                                                              | Orange                                 |             |                                                                                                                            | The code is ready but not merged yet                                                                                                                                        |
| Storage         | Backup and Restore API for Independent Software Vendors                                        | ?                      | ?                                                                                                    | ?                                      | ?           | ?                                                                                                                          |                                                                                                                                                                             |
| Storage         | Allow resign/force re-election of SPM                                                          | ?                      | ?                                                                                                    | ?                                      | ?           | ?                                                                                                                          |                                                                                                                                                                             |
| SLA             | [oVirt scheduler](Features/oVirt_scheduler)                                         | Must                   | [gchaplik@redhat.com](User:GChaplik)                                                      | orange - in progress                   | 1/7/2013    | ?                                                                                                                          |                                                                                                                                                                             |
| SLA             | [Scheduling API](Features/Scheduling_API)                                           | Must                   | [gchaplik@redhat.com](User:GChaplik)                                                      | orange - in progress                   | 1/7/2013    | ?                                                                                                                          |                                                                                                                                                                             |
