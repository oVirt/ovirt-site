...
[id="chap-Administrative_Tasks_{context}"]
...
[id="sect-Updating_Virtual_Machine_Guest_Agents_and_Drivers_{context}"]
...
[id="sect-Virtual_Machines_and_Permissions_{context}"]
...
[id="sect-Affinity_Groups_{context}"]
...
[id="sect-Affinity_Labels_{context}"]
...
[id="sect-Exporting_and_Importing_Virtual_Machines_and_Templates_{context}"]
...
[id="sect-Migrating_Virtual_Machines_Between_Hosts_{context}"]
...
[id="sect-Improving_Uptime_with_Virtual_Machine_High_Availability_{context}"]
...
[id="sect-Other_Virtual_Machine_Tasks_{context}"]
...
[id="sect-Configuring_Red_Hat_Enterprise_Linux_5.4_and_Higher_Virtual_Machines_to_use_SPICE_{context}"]
