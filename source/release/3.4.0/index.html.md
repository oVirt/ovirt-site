...
*   **Note** that on Fedora 19 you'll need to enable Fedora updates-testing repository for having updated openstack packages (should be in updates after Jan 23th).
...
*   all-in-one is not currently working due to issues in SDK and setup
