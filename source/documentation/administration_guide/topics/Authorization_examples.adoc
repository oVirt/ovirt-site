[id="Authorization_examples_{context}"]
...
[id="VM_Cluster_Permissions-1_{context}"]
.Cluster Permissions
====
...
[id="VM_UserVmManager_Permissions-1_{context}"]
...
[id="DataCenter_Power_User_Role_Permissions-1_{context}"]
...
[id="Network_Role_Permissions_{context}"]
...
[id="Custom_Role_Permissions-1_{context}"]
...
[id="rhv-object-hierarchy_{context}"]
