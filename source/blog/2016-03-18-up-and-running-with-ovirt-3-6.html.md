...
In November, version 3.6 of oVirt, the open source virtualization management system, [hit FTP mirrors](http://lists.ovirt.org/pipermail/announce/2015-November/000205.html) featuring a whole slate of [fixes and enhancements](/OVirt_3.6_Release_Notes), including support for storing oVirt's self hosted management engine on a [Gluster volume](http://www.ovirt.org/Features/Self_Hosted_Engine_Gluster_Support).
