...
. link:{URL_virt_product_docs}{URL_format}installing_{URL_product_virt}_as_a_self-hosted_engine_using_the_cockpit_web_interface/index#configuring_a_host_for_pci_passthrough_she_cockpit_deploy[Configuring the host for PCI passthrough]
