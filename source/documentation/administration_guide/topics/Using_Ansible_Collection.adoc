...
The following procedure guides you through creating and running a playbook that uses *oVirt Ansible Collection* to configure {virt-product-fullname}.
This example uses Ansible to connect to the Manager on the local machine and create a new data center.
