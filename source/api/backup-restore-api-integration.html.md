...
3.  Phase 3 will cover Change Block Tracking (CBT) to cover incremental backups. This also on the ongoing community work in qemu block layer to provide differential info.
