...
[WARNING]
====
With *Custom* preview, only selected disks are restored.
Unselected disks will be removed after you click *Commit*.
Select all required disks before committing to avoid data loss.
====
+
