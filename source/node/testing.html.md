...
|--------------------------------------------------------------------------------------|------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| Update - Basic update                                                                | hard       | 0%       | Needs some igor changes (support for 'persistent' VMs)                                                                                                | 2012-11-15 |
| Engine registration - Regsiter with an existing Engine instance                      | hard       | 0%       | Should be possible with igor's current featureset                                                                                                     | 2012-11-15 |
