...
. Subscribe to RHEL EUS channels
+
[source,terminal,subs="normal"]
----
# subscription-manager repos \
...
. Update the Self-Hosted Engine using the procedure  link:{URL_virt_product_docs}{URL_format}/upgrade_guide/index#Updating_a_self-hosted_engine_minor_updates[Updating a Self-Hosted Engine]
