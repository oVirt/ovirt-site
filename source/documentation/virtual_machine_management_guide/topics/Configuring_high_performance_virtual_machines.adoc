...
[id="Configuring_High_Performance_Virtual_Machines_Templates_and_Pools_{context}"]
...
=== Automatic High Performance Configuration Settings [id="Automatic_High_Performance_Configuration_Settings_{context}"]
...
=== I/O and Emulator Threads Pinning Topology (Automatic Settings) [id="IO_and_Emulator_Threads_Pinning_Topology_{context}"]
...
[id="Configuring_Recommended_Manual_Settings_{context}"]
...
=== Manual High Performance Configuration Settings [id="Manual_High_Performance_Configuration_Settings_{context}"]
...
=== Pinning CPUs [id="Pinning_CPU_{context}"]
...
=== Setting the NUMA Pinning Policy [id="Setting_NUMA_Nodes_{context}"]
...
=== Configuring Huge Pages [id="Configuring_Huge_Pages_{context}"]
...
=== Disabling KSM [id="Disabling_KSM_{context}"]
