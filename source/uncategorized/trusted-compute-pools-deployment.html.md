...
User may want to configure vdc_options to override the default values, these configurations include: options default value SecureConnectionWithOATServers true
