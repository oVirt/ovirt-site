...
| Infra           | [Device Custom Properties](Features/Device Custom Properties)                       | must                   | [ Martin Perina](User:mperina) - infra [ Assaf Muller](User:amuller) - network | Orange - In progress, , see comment    | ?           | ?                                                                                     | This feature is spread over infra network and storage. The infra aspect is covered by Martin, the network part is covered by Assaf and the storage part is not covered ATM. |
...
| Infra           | [ExternalTasks](Features/ExternalTasks)                                             | Must                   | [ Eli Mesika](User:emesika)                                                               | Orange - In progress, not submitted    | ?           | ?                                                                                     | Only backend side done, Missing API implementation and testing                                                                                                              |
| Infra           | [Supervdsm service](Features/Supervdsm_service)                                     | ?                      | ?                                                                                                    | ?                                      | ?           | ?                                                                                     |                                                                                                                                                                             |
| Networking      | [Normalized ovirtmgmt Initialization](Features/Normalized ovirtmgmt Initialization) | Must                   | [ Moti Asayag](User:masayag)                                                              | Orange - In progress, partially merged | ?           | ?                                                                                     | Missing documentation of the feature, which is crucial because of the behavioural change this feature introduces.                                                           |
| Networking      | [Migration Network](Features/Migration Network)                                     | Must                   | [ Alona Kaplan](User:alkaplan)                                                            | Green                                  | ?           | [Features/Migration_Network#Testing](Features/Migration_Network#Testing) |                                                                                                                                                                             |
| Networking      | [Quantum Integration](Features/Quantum_Integration)                                 | Should                 | [ Michael Kolesnik](User:mkolesni)                                                        | Orange - In progress, partially merged | ?           | ?                                                                                     | ?                                                                                                                                                                           |
...
| Networking      | [Multiple Gateways](Features/Multiple Gateways)                                     | Must                   | [ Assaf Muller](User:amuller)                                                             | Red - no code written                  | 2013-06-24  | [Features/Multiple_Gateways#Testing](Features/Multiple_Gateways#Testing) |                                                                                                                                                                             |
