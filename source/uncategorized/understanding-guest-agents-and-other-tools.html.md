...
| oVirt Guest Agent | [Yes](How_to_install_the_guest_agent_in_Fedora)  | Yes(5)      | Yes(5)      | [Yes](How_to_install_the_guest_agent_in_Ubuntu)  | [Yes](How_to_install_the_guest_agent_in_Debian)    | [Yes](Feature/GuestAgentOpenSUSE) | [Yes](Feature/GuestAgentSLES) |
| VirtIO Drivers    | Built-in(3)                                                 | Built-in(3) | Built-in(3) | Built-in(3)                                                 | Built-in(3)                                                   | Built-in(3)                                  | Built-in(3)                              |
| Spice Agent       | Yes(4)                                                      | Yes(4)      | Yes(4)      | Yes(4)                                                      | Yes(4)                                                        | -                                            | -                                        |
