...
[id="Cluster_Optimization_Settings_Explained_{context}"]
...
[id="Memory_Optimization_settings_{context}"]
...
|*CPU Threads* |Selecting the *Count Threads As Cores* check box enables hosts to run virtual machines with a total number of processor cores greater than the number of cores in the host.
