...
*   Developing and executing test plans and [Test Cases](http://www.ovirt.org/develop/infra/testing/test-cases/) to test important functionality in a systematic way, usually with multiple cooperating testers
...
* 4.1.1:
  - Tracker: [oVirt 4.1.1 release](https://bugzilla.redhat.com/buglist.cgi?quicksearch=target_milestone%3Aovirt-4.1.1)
  - [oVirt 4.1.z Release Management](http://www.ovirt.org/develop/release-management/releases/4.1.z/release-management/)
