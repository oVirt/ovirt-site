...
| Infra           | [Java SDK (a Java bindings to oVirt engine)](Features/Java_SDK)                                                             | Must                   | [ Michael Pasternak](User:Michael pasternak)                                              | Green - Merged                                              |               | <http://www.ovirt.org/Features/Java_SDK_3.3#Testing>                                                                       | Merged                                                                                                                                                                                                         |
...
| SLA             | [Network QoS](Features/Design/Network_QoS)                                                                                  | Must                   | [Ofri Masad](User:OMasad)                                                                 | waiting for VNIC Profiles                                   |               | ?                                                                                                                          |                                                                                                                                                                                                                |
...
| Gluster         | [Gluster Hooks Management](Features/Gluster Hooks Management)                                                               | Should                 | [Sahina Bose](User:Sahina)                                                                | Orange                                                      | 17/06/2013    | [Gluster Hooks Management Testing](Features/Gluster Hooks Management#Test_Cases)                                | REST API to be merged                                                                                                                                                                                          |
| Gluster         | [Gluster Swift Management](Features/Gluster Swift Management)                                                               | Should                 | [Sahina Bose](User:Sahina), avishwan@redhat.com (vdsm)                                    | orange                                                      | 28/06/2013    | [Features/Gluster Swift Management#Test_Cases](Features/Gluster Swift Management#Test_Cases)                  | REST API submitted, to be merged                                                                                                                                                                               |
...
| Integration     | [Otopi Infra Migration](Features/Otopi_Infra_Migration)                                                                     | Must                   | [ sbonazzo@redhat.com](User:SandroBonazzola)                                              | Green                                                       | 29/6/2013     | ?                                                                                                                          |                                                                                                                                                                                                                |
...
*   [Features/Java_SDK (a Java bindings for oVirt engine)](Features/Java_SDK (a Java bindings for oVirt engine))
