...
1. Download the latest version of ovirt Node from [oVirt Node release](http://ovirt.org/releases/3.1/tools/ovirt-node-iso-2.5.5-0.1.fc17.iso) and burn the ISO image onto a disc.
