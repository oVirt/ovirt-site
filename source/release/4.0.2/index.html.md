...
The oVirt Project is pleased to announce the availability of oVirt 4.0.2 Second Release Candidate as of July 27st, 2016.
...
##### Team: Network
 ...
 - [BZ 1195208](https://bugzilla.redhat.com/1195208) <b>[RFE][scale] - add support for native Open vSwitch for network configuration.</b><br>Feature:<br>Support for native Open vSwitch networks configuration.<br><br>Reason:<br>First step towards overlay networks and centralized network configuration.<br><br>Result: <br>Feature parity with current Linux bridge based configuration.
