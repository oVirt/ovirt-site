...
. Click menu:Administration[Configure] to open the *Configure* window. The *Roles* tab is selected by default, showing a list of default User and Administrator roles, and any custom roles.
. Click *New*.  
