...
*   Prevent addition of duplicate connections in AddStorageServerConnection and UpdateStorageServerConnection commands. Add logic for block domains, reuse the existing code in both commands. (in implementation)
