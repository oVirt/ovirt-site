...
#### VDSM
 ...
 - [BZ 1168327](https://bugzilla.redhat.com/1168327) <b>Live Merge: optimize internal volume size</b><br>Feature: <br>Reduce (base) volume size to optimal after live merge.<br><br>Reason: <br>During live merge, the base volume is extended to accommodate merging the top volume into it.<br><br>Result: <br>A new verb, reduceVolume, is now called at the of live merge to reduce (base) volume size to optimal.
