...
| Spice Agent       | [Yes](How_to_install_the_spice_guest_agent)      | [Yes](How_to_install_the_spice_guest_agent) | [Yes(3)](How_to_install_the_spice_guest_agent) | [Yes](How_to_install_the_spice_guest_agent)      | [Yes](How_to_install_the_spice_guest_agent)     | -                                            | -                                        |

*(3) Built-in with release 6.6 (possibly earlier)*
