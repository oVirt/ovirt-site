...
* image:/documentation/intro-vm-portal/images/1.png[] `Header bar`
+
...
* image:/documentation/intro-vm-portal/images/2.png[] `Toolbar`
+
The toolbar contains buttons that allow you to perform additional actions.

* image:/documentation/intro-vm-portal/images/3.png[] `Virtual machines pane`
+
