...
For more information on the hardware requirements for direct device assignment, see link:{URL_virt_product_docs}{URL_format}planning_and_prerequisites_guide/index#PCI_Device_Requirements_oVirt_planning[PCI Device Requirements] in the _Planning and Prerequisites Guide_.
