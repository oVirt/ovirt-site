...
.. If multipath configuration is not available on the newly installed host, blacklist the Gluster devices. The inventory file is already created in the first host as part of the step _Blacklist the devices used for Gluster bricks_.
+
