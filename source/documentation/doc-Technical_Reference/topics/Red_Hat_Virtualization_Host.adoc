...
[[figu-Technical_Reference_Guide-Red_Hat_Virtualization_Hypervisor-Host_Architecture]]
.Host Architecture
image::983.png[]
...
[[form-Technical_Reference_Guide-Red_Hat_Virtualization_Hypervisor-VDSM_REG]]
