...
Follow below exmaple to make a oVirt node recognized as "trusted" by the attestation service. You can open the following two links, and refer to **1.5 Provision White List Database** to add corresponding information into database.
