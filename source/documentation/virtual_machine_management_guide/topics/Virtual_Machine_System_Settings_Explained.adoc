...
For more information, see link:{URL_virt_product_docs}administration_guide/index.html#About_UEFI_Q35-cluster_opt_settings[UEFI and the Q35 chipset] in the _Administration Guide_.
| Yes.
