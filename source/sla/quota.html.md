...
***org.ovirt.engine.core.common.businessentities.QuotaStatic*** - A business entity that reflects quota static (see [quota_static](CategoryRhev31/Quota#Quota_Static))
