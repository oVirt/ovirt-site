...
|Conroe, Penryn, Opteron G1, Opteron G2, and Opteron G3 CPU types |Use link:{URL_virt_product_docs}{URL_format}planning_and_prerequisites_guide/index#CPU_Requirements_oVirt_planning[newer CPU types].
