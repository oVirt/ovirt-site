...
* Start a virtual machine by clicking the *Run* button (image:/documentation/introduction_to_the_vm_portal/images/Run.png[width=20px]). It is available when the virtual machine is suspended or stopped.
* Access the console of a virtual machine by clicking the *Console* button (image:/documentation/introduction_to_the_vm_portal/images/Console.png[width=20px]). It is available when the virtual machine is running.
