...
. Save the registry, seal the Windows virtual machine, and create a new template. See link:{URL_virt_product_docs}vmm-guide/Virtual_Machine_Management_Guide.html#chap-Templates[Templates] in the _Virtual Machine Management Guide_ for details.
====
