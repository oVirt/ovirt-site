...
====
// See the link:{URL_virt_product_docs}vmm-guide/Virtual_Machine_Management_Guide.html#What_is_high_availability[_Virtual Machine Management Guide_] for information about virtual machine leases.
