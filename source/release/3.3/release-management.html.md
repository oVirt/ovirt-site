...
|-----------------|----------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Virt            | [RAM Snapshots](Features/RAM Snapshots)                                                                                     | ?                      | [ Arik Hadas](User:ahadas)                                                                | Orange -on review                                           | June 25th     | ?                                                                                                                          | vdsm part meged, engine part patches should be in soon - handling memory snapshots on export/import operations remained, REST part on review - at risk for feature complete                                    |
...
| Virt            | [SPICE HTML5 client integration](Features/SpiceHTML5)                                                                       | ?                      | [ Frantisek Kobzik](User:fkobzik)                                                         | Green                                                       | June 25th     |                                                                                                                            |                                                                                                                                                                                                                |
...
| Virt            | [Cloud-Init Integration](Features/Cloud-Init_Integration)                                                                   | ?                      | [Greg Padgett](User:Gpadgett)                                                             | Orange                                                      | ?             | ?                                                                                                                          | Initial patches reviewed, expecting merge in couple of days. REST at risk and may not make the deadline                                                                                                        |
...
| Infra           | [ExternalTasks](Features/ExternalTasks)                                                                                     | Must                   | [ Eli Mesika](User:emesika)                                                               | Orange - In progress, not submitted                         | 2013-06-25    | | [Features/ExternalTasks#Testing](Features/ExternalTasks#Testing)                                             | backend and API side done including testing, waiting for review                                                                                                                                                |
...
| SLA             | [oVirt scheduler](Features/oVirt_scheduler)                                                                                 | Must                   | [Gilad Chaplik](User:GChaplik)                                                            | orange - in review                                          | 15/7/2013     | ?                                                                                                                          |                                                                                                                                                                                                                |
| SLA             | [Scheduling API](Features/Scheduling_API)                                                                                   | Must                   | [Gilad Chaplik](User:GChaplik)                                                            | orange - in review                                          | 15/7/2013     | ?                                                                                                                          |                                                                                                                                                                                                                |
| SLA             | [Network QoS](Features/Design/Network_QoS)                                                                                  | Must                   | [Ofri Masad](User:OMasad)                                                                 | orange - in review                                          | 15/7/2013     | ?                                                                                                                          |                                                                                                                                                                                                                |
...
| SLA             | [Trusted compute pools](Trusted_compute_pools)                                                                              | Must                   | <User:OMasad>                                                                                        | green                                                       | 1/7/13        | [Trusted_compute_pools#Test_cases](Trusted_compute_pools#Test_cases)                                        |                                                                                                                                                                                                                |
| Gluster         | [Gluster Hooks Management](Features/Gluster Hooks Management)                                                               | Should                 | [Sahina Bose](User:Sahina)                                                                | Orange                                                      | 17/06/2013    | ?                                                                                                                          | REST API to be merged                                                                                                                                                                                          |
| Gluster         | [Gluster Swift Management](Features/Gluster Swift Management)                                                               | Should                 | [Sahina Bose](User:Sahina), avishwan@redhat.com (vdsm)                                    | orange                                                      | 28/06/2013    | ?                                                                                                                          | Vdsm patches submitted, to be merged, REST API to be done                                                                                                                                                      |
...
| UX              | [GWT Platform Upgrade](Features/GWT_Platform_Upgrade)                                                                       | Should                 | vszocs@redhat.com                                                                                    | Red                                                         | July 31, 2013 | (code change)                                                                                                              |                                                                                                                                                                                                                |
