...
* link:{URL_virt_product_docs}{URL_format}planning_and_prerequisites_guide/index#RHV-manager-firewall-requirements_oVirt_planning[Rule "M3"] for the {engine-name} firewall
* link:{URL_virt_product_docs}{URL_format}planning_and_prerequisites_guide/index#host-firewall-requirements_oVirt_planning[Rule "H2"] for the host firewall
