...
= Adding KubeVirt or Openshift Virtualization as an external provider

To run virtual machines in a container on the {container-platform}, you add OpenShift as an external provider in {virt-product-shortname}.
