...
### oVirt 3.4.4 Released!

The oVirt development team is pleased to announce the general availability of oVirt 3.4.4 as of Sept 23th 2014. This release continues to show oVirt as a leading KVM management application and open source alternative to VMware vSphere.

oVirt is available now for Fedora 19, CentOS 6.5, and Red Hat Enterprise Linux 6.5 (or similar).

This release of oVirt includes numerous bug fixes, so see the 3.4.4 release notes for a list of the new features and bugs fixed.

<div class="pull-right">
[ Read the 3.4.4 release notes »](OVirt_3.4.4_Release_Notes)

</div>
<div class="pull-right">
[ Get started with oVirt 3.4.4 now »](Download)
