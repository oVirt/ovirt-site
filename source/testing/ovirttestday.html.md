...
| Create different types of storage domains (NFS, ISCSI, FC, local storage) with 2 or more data domains               | FAILED in iscsi for following issues -- [1](https://bugzilla.redhat.com/show_bug.cgi?id=782432) , [2](https://bugzilla.redhat.com/show_bug.cgi?id=781805) |
