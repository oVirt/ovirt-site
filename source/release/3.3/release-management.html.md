...
| Virt            | [EmulatedMachine](Features/EmulatedMachine)                                                                                 | ?                      | [ Roy Golan](User:rgolan)                                                                 | Orange                                 | May 31st    | ?                                                                                                                          | automatically use the right emulated machine type for QEMU                                                                                                                  |
| Virt            | [SPICE HTML5 client integration](Features/SpiceHTML5)                                                                       | ?                      | [ Frantisek Kobzik](User:fkobzik)                                                         | Red                                    | ?           | ?                                                                                                                          |                                                                                                                                                                             |
| Virt            | [GlusterFS Storage Domain](Features/GlusterFS_Storage_Domain)                                                               | Must                   | Deepak C Shetty (vdsm) & Sharad Mishra (engine)                                                      | Green                                  |             | Coming soon                                                                                                                |                                                                                                                                                                             |
...
| Storage         | [Backup and Restore API for Independent Software Vendors](Features/Backup-Restore_API_Integration)                          | Optional               | Sharad Mishra                                                                                        | Red - Work in Progress                 | ?           | ?                                                                                                                          | IBM guys are working on this feature, need to verify their status                                                                                                           |
