...
| [ovirt-ansible-collection](https://github.com/oVirt/ovirt-ansible-collection) | Ansible collection with official oVirt modules and roles | [47](https://github.com/ovirt/ovirt-ansible-collection/issues) | 45 | 64 |
| [ovirt-engine](https://github.com/oVirt/ovirt-engine) | The oVirt Engine virtualization manager. For issues use http://bugzilla.redhat.com | [32](https://github.com/ovirt/ovirt-engine/issues) | 333 | 212 |
...
| [ovirt-system-tests](https://github.com/oVirt/ovirt-system-tests) | This is a mirror for http://gerrit.ovirt.org, for issues use http://jira.ovirt.org, and choose OST project | [14](https://github.com/ovirt/ovirt-system-tests/issues) | 15 | 30 |
| [vdsm](https://github.com/oVirt/vdsm) | The Virtual Desktop Server Manager. For issues use http://bugzilla.redhat.com. | [12](https://github.com/ovirt/vdsm/issues) | 106 | 130 |
...
| [python-ovirt-engine-sdk4](https://github.com/oVirt/python-ovirt-engine-sdk4) | Python SDK for version 4 of the oVirt Engine API | [4](https://github.com/ovirt/python-ovirt-engine-sdk4/issues) | 4 | 15 |
| [ost-images](https://github.com/oVirt/ost-images) | qcow images for OST | [4](https://github.com/ovirt/ost-images/issues) | 2 | 8 |
...
| [ovirt-engine-api-model](https://github.com/oVirt/ovirt-engine-api-model) | This is a mirror for http://gerrit.ovirt.org, for issues use http://bugzilla.redhat.com | [3](https://github.com/ovirt/ovirt-engine-api-model/issues) | 18 | 20 |
...
| [ovirt-engine-metrics](https://github.com/oVirt/ovirt-engine-metrics) | Used to configure and deploy oVirt metrics, logs collection and integration with the central metrics store | [2](https://github.com/ovirt/ovirt-engine-metrics/issues) | 7 | 11 |
...
| [releng-tools](https://github.com/oVirt/releng-tools) | Release management tools and configuration files for oVirt release engineering | [1](https://github.com/ovirt/releng-tools/issues) | 5 | 7 |
...
| [ovirt-engine-extension-logger-log4j](https://github.com/oVirt/ovirt-engine-extension-logger-log4j) | oVirt Engine Extension which provides the ability tu pass log message from oVirt Engine to existing log4j appenders | [1](https://github.com/ovirt/ovirt-engine-extension-logger-log4j/issues) | 1 | 4 |
