...
[source,terminal,subs="normal"]
----
# yum install ovirt-engine-extension-aaa-misc
----
+
[NOTE]
====
Configuration for this package extension must be manually reapplied because it is not migrated as part of the backup and restore process.
====
