...
[NOTE]
====
You can identify the host type of an individual host in the {virt-product-fullname} {engine-name} by selecting the host's name to open the details view, and checking the *OS Description* under *Software*.
====
