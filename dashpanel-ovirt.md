...
|---|---|---|---|---|
| [ovirt-web-ui](https://github.com/oVirt/ovirt-web-ui) | Modern lightweight UI for standard (non-admin) oVirt users | [56](https://github.com/ovirt/ovirt-web-ui/issues) | 79 | 65 |
| [ovirt-ansible-collection](https://github.com/oVirt/ovirt-ansible-collection) | Ansible collection with official oVirt modules and roles | [49](https://github.com/ovirt/ovirt-ansible-collection/issues) | 43 | 63 |
| [ovirt-site](https://github.com/oVirt/ovirt-site) | oVirt website | [33](https://github.com/ovirt/ovirt-site/issues) | 71 | 299 |
| [terraform-provider-ovirt](https://github.com/oVirt/terraform-provider-ovirt) | Terraform provider for oVirt 4.x | [27](https://github.com/ovirt/terraform-provider-ovirt/issues) | 124 | 59 |
...
| [go-ovirt-client](https://github.com/oVirt/go-ovirt-client) | An easy-to-use overlay for the Go SDK. | [14](https://github.com/ovirt/go-ovirt-client/issues) | 5 | 6 |
...
| [vdsm](https://github.com/oVirt/vdsm) | The Virtual Desktop Server Manager. For issues use http://bugzilla.redhat.com. | [13](https://github.com/ovirt/vdsm/issues) | 103 | 126 |
...
| [ovirt-engine](https://github.com/oVirt/ovirt-engine) | This is a mirror for http://gerrit.ovirt.org, for issues use http://bugzilla.redhat.com | [7](https://github.com/ovirt/ovirt-engine/issues) | 331 | 199 |
...
| [ovirt-jenkins-plugin](https://github.com/oVirt/ovirt-jenkins-plugin) | Jenkins plugin to run agents using oVirt | [6](https://github.com/ovirt/ovirt-jenkins-plugin/issues) | 2 | 2 |
...
| [ovirt-release](https://github.com/oVirt/ovirt-release) | This package contains the yum configuration for oVirt repositories. | [3](https://github.com/ovirt/ovirt-release/issues) | 7 | 11 |
...
| [ovirt-hosted-engine-ha](https://github.com/oVirt/ovirt-hosted-engine-ha) | Hosted engine manager for oVirt project. For issues use http://bugzilla.redhat.com | [2](https://github.com/ovirt/ovirt-hosted-engine-ha/issues) | 3 | 13 |
...
| [ovirt-node-ng-image](https://github.com/oVirt/ovirt-node-ng-image) | This is a readonly mirror of the repository with the same name under gerrit.ovirt.org  | [2](https://github.com/ovirt/ovirt-node-ng-image/issues) | 4 | 6 |
| [ovirt-engine-api-model](https://github.com/oVirt/ovirt-engine-api-model) | This is a mirror for http://gerrit.ovirt.org, for issues use http://bugzilla.redhat.com | [2](https://github.com/ovirt/ovirt-engine-api-model/issues) | 18 | 17 |
| [ovirt-appliance](https://github.com/oVirt/ovirt-appliance) | Appliance for oVirt Engine: an OVA shipping CentOS Stream and oVirt Engine, wrapped in an RPM. | [2](https://github.com/ovirt/ovirt-appliance/issues) | 9 | 16 |
...
| [ovirt-engine-ui-extensions](https://github.com/oVirt/ovirt-engine-ui-extensions) | This is a mirror for http://gerrit.ovirt.org, for issues use http://bugzilla.redhat.com | [1](https://github.com/ovirt/ovirt-engine-ui-extensions/issues) | 3 | 9 |
| [ovirt-hosted-engine-setup](https://github.com/oVirt/ovirt-hosted-engine-setup) | Hosted Engine setup tool for the oVirt project. For issues use http://bugzilla.redhat.com | [1](https://github.com/ovirt/ovirt-hosted-engine-setup/issues) | 14 | 23 |
| [ovirt-engine-wildfly](https://github.com/oVirt/ovirt-engine-wildfly) | WildFly packaging for oVirt Engine consumption | [1](https://github.com/ovirt/ovirt-engine-wildfly/issues) | 1 | 4 |
...
| [mom](https://github.com/oVirt/mom) | oVirt Memory Overcommitment Manager, a tool for managing overcommitment on KVM hosts. For issues use https://bugzilla.redhat.com/enter_bug.cgi?product=mom | [1](https://github.com/ovirt/mom/issues) | 11 | 14 |
...
| [ost-images](https://github.com/oVirt/ost-images) | qcow images for OST | [1](https://github.com/ovirt/ost-images/issues) | 0 | 4 |
| [ovirt-engine-nodejs-modules](https://github.com/oVirt/ovirt-engine-nodejs-modules) | Hold the nodejs dependencies needed to build oVirt JavaScript applications with yarn offline | [1](https://github.com/ovirt/ovirt-engine-nodejs-modules/issues) | 0 | 3 |
| [ovirt-dwh](https://github.com/oVirt/ovirt-dwh) | This is a mirror for http://gerrit.ovirt.org, for issues use http://bugzilla.redhat.com | [1](https://github.com/ovirt/ovirt-dwh/issues) | 4 | 16 |
...
| [imgbased](https://github.com/oVirt/imgbased) | imgbased provides a specific management method to derive writeable filesystem layers from read-only base images. | [1](https://github.com/ovirt/imgbased/issues) | 5 | 4 |
| [buildcontainer](https://github.com/oVirt/buildcontainer) | Container image for building oVirt | [1](https://github.com/ovirt/buildcontainer/issues) | 0 | 2 |
