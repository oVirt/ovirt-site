...
* *Disabled*: Parallel migrations are disabled.
* *Auto*: The number of parallel connections is automatically determined. This setting can also be used to automatically disable parallel connections.
* *Auto Parallel*: The number of parallel connections is automatically determined.
* *Custom*: Allows you to specify the preferred number of parallel connections, between 2 and 255.
|
|
|*Number of VM Migration Connections* |Allows you to specify the number of virtual machine migration connections.
