...
The oVirt Project is preparing oVirt 3.4.1 candidate release for testing. This page is still a work in progress.
...
`# yum localinstall `[`http://resources.ovirt.org/pub/yum-repo/ovirt-release.noarch.rpm`](http://resources.ovirt.org/pub/yum-repo/ovirt-release.noarch.rpm)
      # yum-config-manager --enable ovirt-3.4-prerelease
