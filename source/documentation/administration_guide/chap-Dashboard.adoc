...
// See link:{URL_virt_product_docs}data_warehouse_guide/#chap-installing_and_configuring_data_warehouse[Installing and Configuring Data Warehouse] in the _Data Warehouse Guide_.
