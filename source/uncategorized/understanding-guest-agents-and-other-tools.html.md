...
| oVirt Guest Agent | [Yes](How_to_install_the_guest_agent_in_Fedora)  | Yes(3)                                                    | Yes(3)                                                    | [Yes](Feature/GuestAgentUbuntu)                  | [Yes](How_to_install_the_guest_agent_in_Debian) | [Yes](Feature/GuestAgentOpenSUSE) | [Yes](Feature/GuestAgentSLES) |
| VirtIO Drivers    | Built-in                                                    | Built-in                                                  | Built-in                                                  | Built-in                                                    | Built-in                                                   | Built-in                                     | Built-in                                 |
| Spice Agent       | [Yes](How_to_install_the_spice_guest_agent)      | [Yes(4)](How_to_install_the_spice_guest_agent) | [Yes(4)](How_to_install_the_spice_guest_agent) | [Yes](How_to_install_the_spice_guest_agent)      | [Yes](How_to_install_the_spice_guest_agent)     | -                                            | -                                        |

*(3) Available in EPEL repository*

*(4) Built-in with release 6.6 (possibly earlier)*
