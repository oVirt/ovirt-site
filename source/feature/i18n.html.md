...
| Data Center Name        | DataCenterModel | Data Center->new/edit->Name                                          | NONE                                                                              | NOT_YET_PUSCHED                 |
| Cluster Name            | ClusterModel    | Clusters->new/edit->General->Name                                   | NONE                                                                              | [2](http://gerrit.ovirt.org/3213) |
| Host Address            | HostModel       | Hosts->new/edit->General->Address                                   | NONE                                                                              | NONE                              |
| Host Name               | HostModel       | Hosts->new/edit->General->Name                                      | NONE                                                                              | NONE                              |
| VM Name                 | UnitVmModel     | Virtual Machines->new server/new desktop/edit->General->Name        | Extended->Virtual Machines->new server/new desktop/edit->General->Name        | [3](http://gerrit.ovirt.org/3353) |
| Template Name           | UnitVmModel     | Template->edit->General->Name                                       | Extended->Template->edit->General->Name                                       | [4](http://gerrit.ovirt.org/3353) |
| VM Description          | UnitVmModel     | Virtual Machines->new server/new desktop/edit->General->Description | Extended->Virtual Machines->new server/new desktop/edit->General->Description | [5](http://gerrit.ovirt.org/3353) |
| Template Description    | UnitVmModel     | Template->edit->General->Description                                | Extended->Template->edit->General->Description                                | [6](http://gerrit.ovirt.org/3353) |
| NFS Storage Export Path | NfsStorageModel | Storage->new/import->NFS->Export path                               | NONE                                                                              | [7](http://gerrit.ovirt.org/3344) |
...
|------------------------|-----------------------------------------|------------------------------------|
| Tag Name               | tags.name                               | [8](http://gerrit.ovirt.org/3145)  |
| Bookmark Name          | bookmarks.name                          | NONE                               |
| Bookmars Search String | bookmarks.value                         | NONE                               |
| Data Center Name       | storage_pool.name                      | [9](http://gerrit.ovirt.org/3162)  |
| Cluster Name           | VDSGroup.name                           | [10](http://gerrit.ovirt.org/3214) |
| Host Address           | VdsStatic.ip                            | NONE                               |
| VM Name                | VmStatic.name                           | [11](http://gerrit.ovirt.org/3354) |
| Template Name          | VmTemplate.name                         | [12](http://gerrit.ovirt.org/3354) |
| VM Description         | VmBase.description                      | [13](http://gerrit.ovirt.org/3354) |
| Template Description   | VmBase.description                      | [14](http://gerrit.ovirt.org/3354) |
