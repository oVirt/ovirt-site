...
This quick start guide is adapted from the RHEV 3.0 quick start guide. The fundamentals are the same between RHEV and oVirt, but this document requires a good deal more de-RHEV-ification and checking against oVirt 3.1 before it can be considered complete.

adapted from: <http://docs.redhat.com/docs/en-US/Red_Hat_Enterprise_Virtualization/3.0/html/Quick_Start_Guide/index.html>
