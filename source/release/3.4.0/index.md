...
To find out more about features which were added in previous oVirt releases, check out the [oVirt 3.3 release notes](../3.3.0/),
[oVirt 3.2 release notes](../3.2.0/) and [oVirt 3.1 release notes](../3.1.0/).
...
If you're upgrading from oVirt 3.1, you should upgrade to 3.2 before upgrading to 3.4. Please read [oVirt 3.1 to 3.2 upgrade](../3.1.0/to-3.2-upgrade.html) before starting the upgrade.
