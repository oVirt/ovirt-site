...
| link:{URL_virt_product_docs}installing_ovirt_as_a_self-hosted_engine_using_the_cockpit_web_interface#Migrating_the_self-hosted_engine_database_SHE_cockpit_deploy[No, but can be enabled].
...
| Disabled by default. link:{URL_virt_product_docs}installing_ovirt_as_a_self-hosted_engine_using_the_cockpit_web_interface#Migrating_the_self-hosted_engine_database_SHE_cockpit_deploy[No, but can be enabled].
|===
