...
To find out more about features that were added in previous oVirt releases, check out the [oVirt 3.3.2 release notes](../3.3.2/), [oVirt 3.3.1 release notes](../3.3.1/), [oVirt 3.3 release notes](../3.3.0/), [oVirt 3.2 release notes](../3.2.0/), and [oVirt 3.1 release notes](../3.1.0/).

For a general overview of oVirt, read [the oVirt 3.0 feature guide](../3.0.0/feature-guide.html) and the [about oVirt](/community/about.html) page.
...
If you're upgrading from oVirt 3.2, you should read [oVirt 3.2 to 3.3 upgrade](../3.2.0/to-3.3-upgrade.html)

If you're upgrading from oVirt 3.1, you should upgrade to 3.2 before upgrading to 3.3.3. Please read [oVirt 3.1 to 3.2 upgrade](../3.1.0/to-3.2-upgrade.html) before starting the upgrade.
