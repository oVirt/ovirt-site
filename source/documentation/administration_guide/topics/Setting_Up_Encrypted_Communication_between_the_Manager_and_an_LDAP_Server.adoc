[id="Setting_Up_Encrypted_Communication_between_the_Manager_and_an_LDAP_Server_{context}"]
// old ID to prevent broken links:
[id="Setting_Up_SSL_or_TLS_Connections_between_the_Manager_and_an_LDAP_Server_{context}"]
