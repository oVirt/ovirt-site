...
Upgrading from oVirt 3.0 to oVirt 3.1 is **not** recommended. Users are instead advised to use the migration process as documented on this page. Upgrade instructions are however available, refer to [OVirt 3.0 to 3.1 upgrade](../3.0.0/to-3.1-upgrade.html) for more information.
