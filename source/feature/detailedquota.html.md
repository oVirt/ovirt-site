...
*   When the Administrator choose to use Quota, he should change the Data Center Quota mode to audit or enforce(see [DC Quota Enforcement](Features/DetailedQuota/Quota#DataCenterQuotaStages))
