[id="Editing_VFs_on_NIC_{context}"]
...
* For a vNIC to be attached to a VF must, its passthrough property must be enabled. For details, see xref:Enabling_Passthrough_on_a_vNIC_Profile[].
