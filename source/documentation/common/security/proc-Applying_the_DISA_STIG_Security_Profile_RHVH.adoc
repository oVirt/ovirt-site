...
image:common/images/security-policy.png[title="Security Policy"]
...
+
image:common/images/security-policy-selected.png[title="Security Policy"]
+
[NOTE]
====
...
image:common/images/security-policy-rhvh-login.png[title="Login notice"]
