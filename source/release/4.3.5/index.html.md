...
The oVirt Project is pleased to announce the availability of the 4.3.5 Fourth Release Candidate as of July 03, 2019.
...
#### oVirt Engine
 ...
 - [BZ 1700319](https://bugzilla.redhat.com/1700319) <b>VM is going to pause state with "storage I/O  error".</b><br>
 - [BZ 1711691](https://bugzilla.redhat.com/1711691) <b>After export/import template/VM with disk , the disk size is rounded down</b><br>
