...
* Red Hat does not recommend memory ballooning and overcommitment for workloads that require continuous high-performance and low latency. See link:{URL_virt_product_docs}vmm-guide/Virtual_Machine_Management_Guide.html[Configuring High-Performance Virtual Machines, Templates, and Pools].
...
* Red Hat does not recommend KSM and overcommitment for workloads that require continuous high-performance and low latency. See link:{URL_virt_product_docs}vmm-guide/Virtual_Machine_Management_Guide.html[Configuring High-Performance Virtual Machines, Templates, and Pools].
