...
For a detailed description of the above features and a complete list of the features included in this release please see [oVirt 3.6 features list](/develop/release-management/features/3.6-features.html)
...
If you are upgrading from oVirt < 3.5.0, you must first upgrade to oVirt 3.5.0 or later. Please see [oVirt 3.5.5 Release Notes](../3.5.5/) for upgrade instructions.
