...
You can create a custom `sysprep` file when creating a pool of Windows virtual machines, to accommodate various operating systems and domains. See link:{URL_virt_product_docs}administration_guide/#Creating_a_VM_Pool[Creating a Virtual Machine Pool] in the _Administration Guide_ for details.
