...
The {engine-appliance-name} is installed during the deployment process; however, if required, you can install it on the deployment host before starting the installation:

----
# yum install ovirt-engine-appliance
----

Manually installing the {engine-name} virtual machine is not supported.
...
Certain portions of this text first appeared in the link:https://access.redhat.com/documentation/en-us/red_hat_virtualization/{vernum_rhv}/html-single/installing_red_hat_virtualization_as_a_self-hosted_engine_using_the_command_line/[Red Hat Virtualization {vernum_rhv} Installing Red Hat Virtualization as a self-hosted engine using the command line]. Copyright © 2020 Red Hat, Inc. Licensed under a link:http://creativecommons.org/licenses/by-sa/3.0/[Creative Commons Attribution-ShareAlike 3.0 Unported License].
