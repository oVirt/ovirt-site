...
*   Write down the configuration you used (HW, console, etc) and what you've tested in the [report etherpad](http://etherpad.ovirt.org/p/3.4-testday-1)
...
`(el)   sudo yum localinstall `[`http://dl.fedoraproject.org/pub/epel/6/x86_64/epel-release-6-8.noarch.rpm`](http://dl.fedoraproject.org/pub/epel/6/x86_64/epel-release-6-8.noarch.rpm)
`          sudo yum localinstall `[`http://resources.ovirt.org/releases/ovirt-release-el6-10.0.1-2.noarch.rpm`](http://resources.ovirt.org/releases/ovirt-release-el6-10.0.1-2.noarch.rpm)
...
| Infra           | Authentication Refactoring                                                                                                               | [ Juan Hernandez](User:juan)                    | Green                       |                                                                          |                                                                      |                |              |
...
| integration     | ovirt-engine URI rework                                                                                                                  | [Alon Bar-Lev](User:Alonbl)                     | Green                       |                                                                          |                                                                      |                |              |
...
| sla             | [positive/negative affinity between group of Vms](Features/VM-Affinity)                                                       | [ Gilad Chaplik](User:gchaplik)                 | Green                       |                                                                          |                                                                      |                |              |
...
| storage         | [read only disks](Features/Read Only Disk)                                                                                    | [ Sergey Gotliv](User:sgotliv)                  | Green                       |                                                                          |                                                                      |                |              |
| storage         | [single disk snapshots](Features/Single Disk Snapshot)                                                                        | [ Daniel Erez](User:Derez)                      | Green                       | <http://www.ovirt.org/Features/Single_Disk_Snapshot#Testing>             |                                                                      | , {BZ|1056922} |              |
...
| virt            | Features/Guest Reboot | "reboot VM" functionality]]                                                                                      | [Martin Betak](User:Mbetak)                     | Green                       |                                                                          |                                                                      |                |              |
...
| virt            | [Allow to disable SSO per VM](Features/SSO Method Control)                                                                    | [Frank Kobzik](User:Fkobzik)                    | Green                       |                                                                          |                                                                      |                |              |
...
| virt            | add events for remote console connection                                                                                                 | [ Oved Ourfalli](User:ovedo)                    | Green                       |                                                                          |                                                                      |                |              |
| virt            | Fix Control-Alt-Delete functionality in console options                                                                                  | [Frank Kobzik](User:Fkobzik)                    | Green                       |                                                                          |                                                                      |                |              |
| virt            | Show name of the template in General tab for a vm if the vm is deployed from template via clone allocation                               | [ Tomas Jelinek](User:tjelinek)                 | Green                       |                                                                          |                                                                      |                |              |
