...
**Red Hat Virtualization System Administrator Roles - Basic**
...
**Important:** Do not use the administrative user for the directory server as the Red Hat Virtualization administrative user. Create a user in the directory server specifically for use as the Red Hat Virtualization administrative user.
...
**Red Hat Virtualization System Administrator Roles - Advanced**
| Role | Privileges | Notes |
|-
