...
ifdef::rhv-doc[]
|*FIPS mode* |Enables FIPS mode. For details, see xref:enabling_fips_using_the_rhv_manager_appendix_fips[Enabling FIPS using the {engine-name}].
endif::rhv-doc[]
