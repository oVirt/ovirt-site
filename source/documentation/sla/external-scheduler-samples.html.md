...
The external scheduler ships with this sample filter doing just that: [Filter By VM Count](/documentation/sla/filter-by-vm-count/)
...
Luckily we have just that sample already shipping with the external proxy, this proxy scores based on the similarity of the VMs operating system: [Score_KSM_OS](/documentation/sla/score-ksm-os/)
...
An example of this can be found here: [Host_Memory_balance](/documentation/sla/host-memory-balance/)
