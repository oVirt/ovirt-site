...
[id="appe-Reference_Settings_in_Administration_Portal_and_User_Portal_Windows_{context}"]
== Reference: Settings in Administration Portal and VM Portal Windows

[id="sect-Explanation_of_Settings_in_the_New_Virtual_Machine_and_Edit_Virtual_Machine_Windows_{context}"]
