...
2.  The “New Virtual Machine” popup appears.
    1.  ![](/images/wiki/New_VM_WinXP.png)
...
13. Click OK
    ...
    2.  ![](/images/wiki/Add_Virtual_Disk_WinXP.png)
...
4.  Click Ok
    1.  ![](/images/wiki/Run_Once_WinXP.png)
...
If you wish to use the oVirt Guest Tools through the VirtIO-Serial interface, the VirtIO network interface, or a SCSI disk you need to install additional drivers. ![Device Manager](/images/wiki/Device_Manager_WinXP_Missing_Drivers_VirtIO.png)
