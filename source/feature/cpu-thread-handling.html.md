...
*   cpu_real_cores: the number of cores on the host, regardless of the report_host_threads_as_cores setting. Engine would use this value for 3.2 clusters instead of the cpu_cores count.
