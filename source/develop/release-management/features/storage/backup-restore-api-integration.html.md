...
Navigate to the wanted disk snapshot from REST by accessing: ![](/images/wiki/FileRestDesc.jpeg)
...
After the backup VM copy the data from the disk, detach the disk snapshot from the VM using the REST : ![](/images/wiki/DetachDisk.jpeg)
