...
[id="assembly_nvidia_gpu_passthrough"]
...
. xref:Enabling_IOMMU_support_in_the_host_machine_kernel[Enable the I/O Memory Management Unit (IOMMU) on the host machine.]
. xref:Detaching_the_GPU_device_from_the_host[Detach the GPU from the host.]
. xref:Attaching_the_GPU_to_a_Virtual_Machine[Attach the GPU to the guest.]
. xref:proc_install-nvidia-vgpu-guest-driver_{context}[Install GPU drivers on the guest.]
. xref:Updating_and_Enabling_xorg[Configure Xorg on the guest.]
...
[id='Enabling_IOMMU_support_in_the_host_machine_kernel']
...
[id='Detaching_the_GPU_device_from_the_host']
...
[id='Attaching_the_GPU_to_a_Virtual_Machine']
