...
| Virt            | [Cloud-Init Integration](Features/Cloud-Init_Integration)                                                                   | ?                      | [Greg Padgett](User:Gpadgett)                                                             | Red                                                         | Jul 25        | ?                                                                                                                          | Initial patches reviewed, REST patch is blocking the rest of the patches, so nothing's in ATM                                                                                                                  |
