...
The Dashboard requires that Data Warehouse is installed and configured. 
// See link:{URL_virt_product_docs}data-warehouse/Data_Warehouse_Guide.html#chap-installing_and_configuring_data_warehouse[Installing and Configuring Data Warehouse] in the _Data Warehouse Guide_.
