...
If you're upgrading from oVirt 3.1 you should upgrade to 3.2 before upgrading to 3.3.4. Please read [oVirt 3.1 to 3.2 upgrade](../3.1.0/to-3.2-upgrade.html) before starting the upgrade.
