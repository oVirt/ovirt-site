...
[id="Virtual_Machine_Run_Once_settings_explained_{context}"]
...
[id="Boot_Options_Fields_{context}"]
...
[id="Linux_Boot_Options_Fields_{context}"]
...
[id="Initial_Run_Fields_Linux_{context}"]
...
|===
[id="Initial_Run_Fields_Win_{context}"]
...
[id="Custom_Properties_Fields_{context}"]
