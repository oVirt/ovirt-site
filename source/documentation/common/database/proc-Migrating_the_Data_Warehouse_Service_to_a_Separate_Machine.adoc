...
To migrate the Data Warehouse database (`ovirt_engine_history`) prior to migrating the Data Warehouse service, see xref:Migrating_the_Data_Warehouse_Database_to_a_Separate_Machine_migrate_DWH[].
...
+
See xref:Migrating_the_Data_Warehouse_Database_to_a_Separate_Machine_migrate_DWH[] for more information on how to configure and migrate the Data Warehouse database.
