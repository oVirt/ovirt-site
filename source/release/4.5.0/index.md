...
The oVirt Project is pleased to announce the availability of the 4.5.0 First Alpha release as of March 16, 2022.
...
#### oVirt Engine
 ...
 - [BZ 2056126](https://bugzilla.redhat.com/show_bug.cgi?id=2056126) **[RFE] Extend time to warn of upcoming certificate expiration**
   RHV Manager 4.4 SP1 certificate expiration check will warn of upcoming certificate expiration earlier:
...
Support setting console type globally for all VMs, existed and new ones, by using the engine-config parameters.
 - [BZ 2023786](https://bugzilla.redhat.com/show_bug.cgi?id=2023786) **RHV VM with SAP monitoring configuration does not fail to start if the Host is missing vdsm-hook-vhostmd**
...
#### oVirt Engine
 ...
 - [BZ 1994144](https://bugzilla.redhat.com/show_bug.cgi?id=1994144) **[RHV 4.4.6] Mail recipient is not updated while configuring Event Notifications**
...
#### VDSM
 ...
 - [BZ 1913387](https://bugzilla.redhat.com/show_bug.cgi?id=1913387) **[CBT] [RFE] Extend backup scratch disk as needed**
...
#### oVirt Engine
 ...
 - [BZ 2061904](https://bugzilla.redhat.com/show_bug.cgi?id=2061904) **Unable to attach a RHV Host back into cluster after removing due to networking**
   
 - [BZ 2056052](https://bugzilla.redhat.com/show_bug.cgi?id=2056052) **RHV-H w/ PCI-DSS profile causes OVA export to fail**
...
64 people contributed to this release:
	...
	Martin Perina (Contributed to: ovirt-ansible-collection, ovirt-dependencies, ovirt-dwh, ovirt-engine, ovirt-engine-keycloak, ovirt-engine-metrics, ovirt-engine-wildfly, ovirt-jboss-modules-maven-plugin, ovirt-release, python-ovirt-engine-sdk4, vdsm, vdsm-jsonrpc-java)
	Martin Tzvetanov Grigorov (Contributed to: ovirt-engine)
	Michal Skrivanek (Contributed to: imgbased, ovirt-appliance, ovirt-dwh, ovirt-engine, ovirt-engine-metrics, ovirt-hosted-engine-setup, ovirt-node-ng-image)
	...
	Nir Soffer (Contributed to: ovirt-engine, ovirt-imageio, ovirt-release, python-ovirt-engine-sdk4, vdsm)
	...
	Yedidyah Bar David (Contributed to: imgbased, otopi, ovirt-ansible-collection, ovirt-appliance, ovirt-dwh, ovirt-engine, ovirt-hosted-engine-ha, ovirt-hosted-engine-setup, ovirt-node-ng-image, ovirt-release, ovirt-setup-lib, ovirt-site)
