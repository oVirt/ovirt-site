...
The {virt-product-fullname} {engine-name} must be installed on a base installation of {enterprise-linux} 7 that has been updated to the latest minor release.
