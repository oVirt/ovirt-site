...
= Upgrading from 4.2 to {virt-product-fullname} 4.3
...
ifdef::rhv-doc[]
. xref:Analyzing_the_Environment_4-2_local_db[Use the Log Collection Analysis tool to check for issues that might prevent a successful upgrade]
endif::[]
