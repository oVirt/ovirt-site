...
| Storage         | Separating "Move" vm operation to "Copy" and "Delete" operations to improve VM availability                   | Optional               | [Liron Aravot](User:laravot)                                                              | Orange                                 |             |                                                                                                                            | The code is ready but not integrated yet                                                                                                                                    |
